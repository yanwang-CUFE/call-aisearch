...
def read_json(file_path):
    ...
    data_list = []
    for i in dict_all:
        data_list.append(dict_all[i]["query"] + dict_all[i]["document"])
    print(len(data_list))
    print(data_list[0])
    print("lala")
    print(data_list[1])
...
xml_list = read_json("combine_all.json")
with torch.no_grad():
...
torch.save(torch_matrix, "./newMatrix/WPYNewdocument92618matrixDocument.pt")
